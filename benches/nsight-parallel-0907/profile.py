...
s.PORT=32506;s.BIN=str(B/'llama-server');s.ENV['LD_LIBRARY_PATH']=str(B)
...
def batch(prompts, n):
    ...
    return rows
variants=[('ordinary-mtp3',3,False,None),('compact-mtp3',3,True,None),('compact-q8pack4',3,True,4),('compact-mtp0',0,True,None)]
results=[]
