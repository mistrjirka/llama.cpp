...
ROOT=pathlib.Path('/models/.bench-ornith-mtp4/fair-frontier'); ROOT.mkdir(parents=True,exist_ok=True)
...
CONFIGS=[
 ('off18-big',False,'18,31',2048,256,0),
 ('off20-big',False,'20,29',2048,256,0),
 ('off21-big',False,'21,28',2048,256,0),
 ('off22-big',False,'22,27',2048,256,0),
 ('mtp16-big',True,'16,33',2048,256,64),
 ('mtp16-small',True,'16,33',512,128,64),
 ('mtp17-small',True,'17,32',512,128,32),
 ('mtp17-big',True,'17,32',2048,256,32),
]
...
def run(cfg,idx):
 label,mtp,split,batch,ubatch,dub=cfg; port=39800+idx
